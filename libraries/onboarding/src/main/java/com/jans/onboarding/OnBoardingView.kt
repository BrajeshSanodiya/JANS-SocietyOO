...
class OnBoardingView : FrameLayout {
    ...
    private inner  class OnBoardingViewPagerAdapter(fm: androidx.fragment.app.FragmentManager) : FragmentStatePagerAdapter(fm) {
        ...
        override fun getItem(position: Int): BoardingScreenFragment {
